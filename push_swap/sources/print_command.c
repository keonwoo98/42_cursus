	...
	print(t_stack *command)
{
	while (command->top->next)
	{
		...
		else if ((command->top->num == 9 && command->top->next->num == 10) || (command->top->num == 10 && command->top->next->num == 9))
		{
			command->top->num = 11;
			command->top->next->num = 0;
		}
		else if ((command->top->num == 4 && command->top->next->num == 5) || (command->top->num == 5 && command->top->next->num == 4))
		{
			command->top->num = 0;
			command->top->next->num = 0;
		}
		else if ((command->top->num == 1 && command->top->next->num == 2) || (command->top->num == 2 && command->top->next->num == 1))
		{
			command->top->num = 3;
			command->top->next->num = 0;
		}
		else if ((command->top->num == 1 && command->top->next->num == 1) || (command->top->num == 2 && command->top->next->num == 2))
		{
			command->top->num = 0;
			command->top->next->num = 0;
		}
		else if ((command->top->num == 6 && command->top->next->num == 9) || (command->top->num == 7 && command->top->next->num == 10))
		{
			command->top->num = 0;
			command->top->next->num = 0;
		}
		else if ((command->top->num == 9 && command->top->next->num == 6) || (command->top->num == 10 && command->top->next->num == 7))
		{
			command->top->num = 0;
			command->top->next->num = 0;
		}
		print_command2(command->top->num);
